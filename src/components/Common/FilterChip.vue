...
<template>
  <span
    class="text-base inline-flex shrink-0 items-center gap-1.5 rounded-full border border-blue-border bg-blue-tint py-[5px] pr-2 pl-2.5 text-blue-ink"
  >
    <span class="text-blue-soft">{{ label }}</span>
